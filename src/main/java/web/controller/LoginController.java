...
import web.service.UserSystemBL.UserService;
...
//    private UserService userService;
    ...
    public @ResponseBody Map<String, Object>
    register(@RequestParam(value="username") String username, @RequestParam(value="password") String password,
        @RequestParam(value="confirm_password") String confirm_password, HttpServletRequest request,
